...
import net.posco.user.export.UserExcelExporter;
import net.posco.user.export.UserPdfExporter;
...
public class UserController {
  ...
  public String deleteUser(
    ...
    return ("redirect:/users/page/{currentPage}?pageSize=" +
        pageSize + "&sortField=" + sortField + "&sortDirection=" + sortDirection);
  }
